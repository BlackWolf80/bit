...
TableTools.prototype = {
	...
	/**
	 * Show a message to the end user1 which is nicely styled
	 *  @param {string} message The HTML string to show to the user1
	...
	/**
	 * Take the user1 input arrays and expand them to be fully defined, and then add them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of user1 defined buttons
